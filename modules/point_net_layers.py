...
def parse_pointnet_layers(in_channel, 
    ...
    layers = []
    # layers.append(make_ssg_layer(radius=None,nsample = 32, in_channel=in_channel+3, mlp=[64, 64, 128], group_all=False))
    # layers.append(make_ssg_layer(radius=None,nsample = 32, in_channel = 128 + 3, mlp = [128, 256] , group_all = False))
    # layers.append(make_ssg_layer(radius=None,nsample = 16, in_channel = 256 + 3, mlp = [256, 512] , group_all = False))
    # layers.append(make_ssg_layer(radius=None,nsample = 8, in_channel = 512 + 3, mlp = [512, 512] , group_all = False))
